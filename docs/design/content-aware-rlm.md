# Content-Aware RLM Pattern — Design Document
...
- **Multi-file RLM** — Analyzing a directory of mixed-type files in one RLM session, with per-file type detection. **Addressed in [Multi-File Directory RLM Design](multi-file-rlm.md).**
