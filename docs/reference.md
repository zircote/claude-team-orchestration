...
|---------|------------|--------|-------------|
| [Parallel Specialists](patterns.md#parallel-specialists) | Multiple independent reviews | 2-5 | None |
| [Pipeline](patterns.md#pipeline) | Sequential stages | 3-5 | Linear chain |
| [Swarm](patterns.md#swarm) | Many similar tasks | 3-5 | None |
| [Research + Implementation](patterns.md#research--implementation) | Learn then build | 2 | Phase gate |
| [Plan Approval](patterns.md#plan-approval) | High-risk changes | 1-2 | Approval gate |
| [Multi-File Refactoring](patterns.md#multi-file-refactoring) | Cross-file changes | 2-4 | Fan-in |
| [RLM](patterns.md#rlm-recursive-language-model) | Files exceeding context | 1 per partition | Fan-out/fan-in |
