...
description: "End-to-end walkthrough from installation to your first successful team run."
---
...
> See [Team Lifecycle](/concepts/concepts/#team-lifecycle) for what happens under the hood.
...
- Read [Patterns](/how-to/patterns/) to learn the seven orchestration patterns
- Read [Agent Types](/reference/agent-types/) to pick the right agent for each role
- Read [Concepts](/concepts/concepts/) to understand how teams, patterns, and RLM work internally
- Read [Reference](/reference/reference/) for message types, task statuses, and configuration options
- Try the [complete workflow examples](/skills/complete-workflows/)
