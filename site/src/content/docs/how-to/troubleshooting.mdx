...
description: "Common failures and fixes for agent teams."
---
...
> See [Known Limitations](/reference/reference/#known-limitations) for current feature limitations.
>
> See [Debugging Commands](/reference/reference/#debugging-commands) for diagnostic shell commands.
