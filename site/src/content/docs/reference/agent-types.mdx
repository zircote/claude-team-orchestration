---
title: "Agent Types"
description: "Which agents are available and when to use each."
---
...
| JSON chunk analysis | **swarm:rlm-json-analyzer** | Schema-aware, structural patterns. Also used by [JSONL Log Analyzer](/skills/jsonl-log-analyzer/) |
...
| `swarm:rlm-json-analyzer` | JSON/JSONL analysis with schema patterns and field distributions (Haiku). Also used by the [JSONL Log Analyzer](/skills/jsonl-log-analyzer/) skill for log-specific schema-aware analysis |
...
- [Choosing Agents for Teams](/how-to/patterns/#choosing-agents-for-teams) — How to pick the right agent when spawning teammates
