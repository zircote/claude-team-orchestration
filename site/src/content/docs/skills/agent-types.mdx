...
- [Team Management](/skills/team-management/) - Spawning agents into teams
- [Orchestration Patterns](/skills/orchestration-patterns/) - Patterns that combine different agent types
...
- `swarm:rlm-json-analyzer` — Haiku model, JSON/JSONL chunk analysis with schema patterns and field distributions. Also used by the [JSONL Log Analyzer](/skills/jsonl-log-analyzer/) skill for log-specific schema-aware analysis
