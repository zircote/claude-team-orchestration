...
- [Team Management](/skills/team-management/) - Shutdown and cleanup procedures
- [Task System](/skills/task-system/) - Task status issues
- [Messaging](/skills/messaging/) - Message debugging
- [Spawn Backends](/skills/spawn-backends/) - Backend troubleshooting
...
See [Team Management](/skills/team-management/) for the full shutdown procedure. In summary:
...
Or enable [delegate mode](/skills/team-management/) to restrict the lead to coordination-only tools.
