...
- [Team Management](/skills/team-management/) - Shutdown and plan approval workflows
- [Task System](/skills/task-system/) - Coordinating task progress
- [Error Handling](/skills/error-handling/) - Debugging message issues

---

## SendMessage Tool

All messaging uses the `SendMessage` tool with three fields: `to`, `message`, and `summary`.
...
- `message` - Message text or structured protocol object (required)
- `summary` - Brief preview for UI (required for plain text messages)
