...
- [Team Management](/skills/team-management/) - Team lifecycle tools
- [Task System](/skills/task-system/) - Task creation and dependencies
- [Messaging](/skills/messaging/) - Inter-agent communication
- [Agent Types](/skills/agent-types/) - Choosing the right agent for each role

**See also:** [Complete Workflows](/skills/complete-workflows/) for full end-to-end examples.
...
**See also:** [RLM Pattern](/skills/rlm-pattern/) for content-type detection, partitioning strategies, and full team lifecycle.
...
See [Multi-File Directory Analysis](/skills/rlm-pattern/#multi-file-directory-analysis) for the full specification and [Multi-File RLM Design](/design/multi-file-rlm/) for the design document.
