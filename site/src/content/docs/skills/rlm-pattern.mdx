...
Extend the single-file RLM pattern to process an entire directory of mixed-type files in one session. See [Multi-File RLM Design](/design/multi-file-rlm/) for the full design document.
