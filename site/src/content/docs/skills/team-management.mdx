...
- [Task System](/skills/task-system/) - Managing work items and dependencies
- [Messaging](/skills/messaging/) - Communication between agents
- [Agent Types](/skills/agent-types/) - Choosing the right agent for each role
- [Spawn Backends](/skills/spawn-backends/) - How teammates run (in-process, tmux, iTerm2)
- [Error Handling](/skills/error-handling/) - Troubleshooting and recovery
...
See [Messaging](/skills/messaging/) for plan approval tool syntax.
